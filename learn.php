...
<section class="video-section">
    ...
    <script>
      ...
      function onYouTubeIframeAPIReady() {
        // Video 1
        createPlayer('player1', 'mAtkPQO1FcA');
        
        // Video 2
        createPlayer('player2', 'lL2PXC1fmnQ');
        
        // Video 3
        createPlayer('player3', 'U4H1q1OGIo8');

        createPlayer('player4', 'ealk6KXYjaA');

        createPlayer('player5', 'DT-7eRsaiIk');

        createPlayer('player6', 'av0oBYKjazs');
      }
    ...
    <div class="quizz-section">
      <a href="beginnerlevel1quiz.php" class="quizz-button">
