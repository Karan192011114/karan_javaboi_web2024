...
h3 {
    ...
    <div class="level-container">
        <img class="grass1" src="grass.png" alt="steps">
        <img class="grass2" src="grass.png" alt="steps" style="left: 379px; top: 397px;">
        <img class="grass3" src="grass.png" alt="steps" style="left: 785px;  top: 242px;">
        <img class="grass4" src="grass.png" alt="steps" style="left: 1174px;  top: 392px;">
          <!-- Level 1 -->
        ...
        <img class="bird" id="bird" src="BIRD.gif" alt="bird" width="500" height="300">
        <div>  
        <button class="moveleft" onclick="moveLeft()">⬅</button>

        <button class="moveright" onclick="moveRight()">➡</button>
       
        <a class="go" id="goLink" href="learnexp.php">GO</a>
        </div>
    </div>
...
<script>
    ...
    function updateGoLink() {
        ...
        switch (currentLevel) {
            case 0:
                goLink.href = 'learnexp.php'; // Change this to the desired destination
                break;
            case 1:
                goLink.href = 'learnexp1.php'; // Change this to the desired destination
                break;
            case 2:
                goLink.href = 'learnexp2.php'; // Change this to the desired destination
                break;
            case 3:
                goLink.href = 'compiler.html'; // Change this to the desired destination
                break;
            default:
                goLink.href = 'learnexp.php'; // Default link
        }
    }
</script>
