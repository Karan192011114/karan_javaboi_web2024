...
h3 {
    ...
    <div class="level-container">
        ...
        <a class="go" id="goLink" href="learn.php">GO</a>
        </div>
    </div>
...
<script>
    ...
    function updateGoLink() {
        ...
        switch (currentLevel) {
            case 0:
                goLink.href = 'learn.php'; // Change this to the desired destination
                break;
            case 1:
                goLink.href = 'learn1.php'; // Change this to the desired destination
                break;
            case 2:
                goLink.href = 'learn2.php'; // Change this to the desired destination
                break;
            case 3:
                goLink.href = 'compiler.html'; // Change this to the desired destination
                break;
            default:
                goLink.href = 'learn.php'; // Default link
        }
    }
</script>
